...
# Route Chrome through undetected-chromedriver (must be pip-installed). Worth
# turning on if Resy starts serving "Access Denied" to the bot's browser.
USE_UNDETECTED = os.getenv("USE_UNDETECTED", "0") in ("1", "true", "True")
